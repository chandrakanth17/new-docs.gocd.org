...
3.  Click on each stage segment to see [stage details](_page.md) for that stage instance.
...
10. Click the pipeline VSM to see the [value stream map](map.md) of that instance of the pipeline.
11. Click the pipeline history to see [pipeline activity](vity_page.md) for that pipeline.
...
-   [Pipeline activity](vity_page.md)
-   [Job details](age.md)
